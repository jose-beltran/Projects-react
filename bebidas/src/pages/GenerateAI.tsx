  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {isGenerating && (
          <div className="flex justify-center items-center h-20 gap-2 flex-row aling-middle ">
            <svg
              aria-hidden="true"
            ...
            <span className="font-bold text-lg animate-wiggle">Generando receta...</span>
          </div>
        )}
        <div className="py-10 whitespace-pre-wrap break-words w-full max-w-4xl mx-auto">
          {recipe && (
            <div className="bg-slate-100 p-10 rounded-lg shadow-md">
